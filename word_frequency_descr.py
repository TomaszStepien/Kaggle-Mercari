...
descriptions['item_description'] = descriptions["item_description"][
    descriptions["item_description"] != "no description yet"]
...
junk_words = ["and", "or", "if", "is", "are", "a", "in", "it", "i", "to", "of", "the", "on", "be", "for", "with",
              "have"]
